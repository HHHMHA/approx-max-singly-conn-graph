...
class ExtraSourceApproxMSCSFTest {
    ...
    void operate() {
        ...
        assertEquals( g3Expected.getEdges(), new ExtraSourceApproxMSCSF( g3 ).operate().getEdges() );
        ...
        assertThrows( IllegalArgumentException.class, () -> new ExtraSourceApproxMSCSF( g4 ).operate() );
    }
}
